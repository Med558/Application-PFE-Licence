...
public class EbayFragment extends Fragment {
    ...
    public static Fragment newInstance(Context context) {
        EbayFragment f = new EbayFragment();
        return f;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_ebay, null);

        bmb = (BoomMenuButton)root.findViewById(R.id.bmb_ebay);
        assert bmb != null;
        ...
        browser.loadUrl("http://www.ebay.fr/");
