...
public class ChaineYoutubeEricssonFragment extends Fragment {
    ...
    ImageView img_video1, img_video2, img_video3, img_video4, img_video5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_chaine_youtube_ericsson, null);

        bmb = (BoomMenuButton)root.findViewById(R.id.bmb_youtube);
        assert bmb != null;
        ...
        img_video1=(ImageView)root.findViewById(R.id.img_video1);
        img_video2=(ImageView)root.findViewById(R.id.img_video2);
        img_video3=(ImageView)root.findViewById(R.id.img_video3);
        img_video4=(ImageView)root.findViewById(R.id.img_video4);
        img_video5=(ImageView)root.findViewById(R.id.img_video5);
        ...
        img_video1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent1.putExtra("lien_video","y6H4Ro78WNE");
        ...
        img_video2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent2.putExtra("lien_video","O3oDnaslQSY");
                startActivity(intent2);
            }
        });

        img_video3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent3 = new Intent(getActivity().getApplicationContext(), YoutubeVideo1Activity.class);
                intent3.putExtra("lien_video","TW1khBuPepY");
                startActivity(intent3);
            }
        });

        img_video4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent4 = new Intent(getActivity().getApplicationContext(), YoutubeVideo1Activity.class);
                intent4.putExtra("lien_video","olqdi7Bu6B4");
                startActivity(intent4);
            }
        });

        img_video5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent5 = new Intent(getActivity().getApplicationContext(), YoutubeVideo1Activity.class);
                intent5.putExtra("lien_video","cCUC6F_HFuc");
