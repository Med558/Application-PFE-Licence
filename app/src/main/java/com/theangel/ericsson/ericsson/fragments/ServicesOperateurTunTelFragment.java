...
import com.theangel.ericsson.ericsson.activities.RechargerSoldeTuntelActivity;
import com.theangel.ericsson.ericsson.activities.TransfertDeCreditOrangeActivity;
import com.theangel.ericsson.ericsson.activities.TransfertDeCreditTuntelActivity;

public class ServicesOperateurTunTelFragment extends Fragment {
    ...
    Button btn_consulter_solde_tuntel, btn_forfait_internet_tuntel, btn_recharger_solde_tuntel, btn_contacter_service_client_tuntel, btn_transfert_de_credit_tuntel;

    public static Fragment newInstance(Context context) {
        ServicesOperateurTunTelFragment f = new ServicesOperateurTunTelFragment();
        return f;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_services_operateur_tun_tel, null);

        bmb = (BoomMenuButton)root.findViewById(R.id.bmb_services_operateur_tuntel);
        assert bmb != null;
        ...
        btn_consulter_solde_tuntel = (Button)root.findViewById(R.id.btn_consulter_solde_tuntel);
        btn_forfait_internet_tuntel = (Button)root.findViewById(R.id.btn_forfait_internet_tuntel);
        btn_recharger_solde_tuntel = (Button)root.findViewById(R.id.btn_recharger_solde_tuntel);
        btn_contacter_service_client_tuntel = (Button)root.findViewById(R.id.btn_contacter_service_client_tuntel);
        btn_transfert_de_credit_tuntel = (Button)root.findViewById(R.id.btn_transfert_de_credit_tuntel);

        btn_consulter_solde_tuntel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (ContextCompat.checkSelfPermission(getActivity().getApplicationContext(), Manifest.permission.CALL_PHONE) ==
                        PackageManager.PERMISSION_GRANTED ){
                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:*122%23"));
        ...
        btn_forfait_internet_tuntel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (ContextCompat.checkSelfPermission(getActivity().getApplicationContext(), Manifest.permission.CALL_PHONE) ==
                        PackageManager.PERMISSION_GRANTED ){
                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:*140%23"));
                    startActivity(intent);
                } else {
                    ActivityCompat.requestPermissions(getActivity(), new String[] {
                                    Manifest.permission.CALL_PHONE},
        ...
        btn_contacter_service_client_tuntel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        btn_recharger_solde_tuntel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), RechargerSoldeTuntelActivity.class);
                startActivity(intent);
            }
        });

        btn_transfert_de_credit_tuntel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), TransfertDeCreditTuntelActivity.class);
                startActivity(intent);
            }
        });
